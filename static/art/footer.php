...
<div class="footer_hw9">
	...
	<ul>
		...
		<li><a href="">FAQ</a></li>
		<li><a href=""><?php echo site::name;?> +</a></li>
	</ul>
	...
	<article class="ft_lightings">
    	<section class="ft_one">
            <section class="ft_two">
                <section class="ft_three">
                    <section class="ft_four">
                        <section class="ft_five">
...
<script src="/static/cj/js.js?<?php echo $reloadStatic;?>"></script>
