...
.header_shopingbag>svg{height:22px;margin-right:4px;}
.header_shopingbag>.h_n{margin-top:6px;margin-right:7px;}
.header_shopingbag>.hd{border-radius: 70%;background: red;padding:6px 8.5px 5px;text-align: center;margin-top: 6px}
