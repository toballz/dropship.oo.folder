...
<head> 
  ...
  <style type="text/css">
     .ttble{border-collapse: collapse; width: 100%;}
     td,th{border-bottom:0.1px dashed#ccc;text-align:left;padding:8px; }
     td:first-child {
            ...
            <div style="padding:12px">
                    ...
                    <table border="1" class="ttble">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                <td><b>Date</b></td> 
                                <td style="color: #44cb44;font-weight:600;"><?php $hss=new DateTime($gs_fetchassoc['date']);echo $hss->format('Y F jS l');?></td>  
                            </tr>
                            <tr> 
                                <td><b>Time</b></td> 
                                <td style="color: #3bc2d3;font-weight:600;"><?php echo date("g:i A", strtotime($gs_fetchassoc['time']));?></td>  
                            </tr>
                            <tr> 
                                <td><b>Price</b></td> 
