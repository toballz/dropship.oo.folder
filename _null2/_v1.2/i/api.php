...
if(isset($_POST['get_messageNotifiy']) && isset($_POST['a'])){
   ...
   //login    
   if(isset($_POST['logine']) && isset($_POST['password']) && isset($_POST['ord'])){
  
    $pasw=md5(base64_decode($_POST['password']));
    $yhd="SELECT `description2` FROM `availability` WHERE `id`='2' AND `namer`='account' AND `description2`='$pasw';";
    //echo $yhd;
    $js = db::stmt($yhd);
